...
body {
	...
	background: linear-gradient(135deg, rgba(109, 131, 242, 0.7),
		rgba(31, 60, 136, 0.7)), url('<c:url value='/images/books.jpg'/>')
...
<body>
	<div class="verify-code-container">
		<h2>Verify Code</h2>
		<form action="<%=request.getContextPath()%>/verifyResetCode"
			method="post">
		...
		<!-- Nút gửi lại mã xác minh -->
		<!-- Resend Code as a text link -->
		<form id="resendCodeForm"
			action="<%=request.getContextPath()%>/verifyResetCode" method="post"
			style="display: none;">
