	...
	<div class="tutor-classes-container">
		<div class="filter-container">
			...
			<div class="filter-dropdown" id="filter-dropdown">
				<a href="#" data-status="New" class="filter-option">New</a> <a
	...
	<script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateClasses(status) {
                // Send an AJAX request to filter classes by status
                fetch('<%=request.getContextPath()%>/AdminssionClassController?action=filterClasses&status=' + status)
                    .then(response => response.text())
                    .then(data => {
                        // Update the classes list with the filtered data
                        document.querySelector('.tutor-classes-list').innerHTML = data;
                    })
