...
<body>
    <div class="container">
        ...
        <form id="create-class-form"
            action="<%=request.getContextPath()%>/AdminssionClassController?action=/createCl"
            method="post">
            ...
            document.getElementById('create-class-form').addEventListener('submit', function(event) {
                ...
                .then(data => {
                    Swal.fire(
                    	...
                    	window.location.href = '<%=request.getContextPath()%>/AdminssionClassController?action=/listClass';
                    });
                })
                .catch(error => {
                    Swal.fire(
