...
<!-- <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> -->
  ...
  -->
	...
	<footer class="footer"
		style="background-image: url('<c:url value='/images/footer-bg.png'/>')">
			...
			<div class="container grid-list">
				...
				<div class="footer-brand">
					...
					<a href="#" class="logo"> <img
						src="<c:url value='/images/logo-light.svg'/>" width="162"
						height="50" alt="EduWeb logo">
					</a>

					<p class="footer-brand-text">Lorem ipsum dolor amet consecto
						adi pisicing elit sed eiusm tempor incidid unt labore dolore.</p>
					...
					<div class="wrapper">
						<span class="span">Call:</span> <a href="tel:+011234567890"
							class="footer-link">+01 123 4567 890</a>
					</div>

					<div class="wrapper">
						<span class="span">Email:</span> <a href="mailto:info@eduweb.com"
							class="footer-link">info@eduweb.com</a>
					</div>
				...
				<ul class="footer-list">
					...
					<li><a href="#" class="footer-link">Sign In/Registration</a></li>
				...
				<div class="footer-list">
					...
					<p class="footer-list-text">Enter your email address to
						register to our newsletter subscription</p>
