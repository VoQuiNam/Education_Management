...
@WebServlet("/AdminssionClassController")
public class AdminssionClassController extends HttpServlet {
	...
	private void showNewForm(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("AdminssionClass/CreateClass.jsp");
		dispatcher.forward(request, response);
	}
